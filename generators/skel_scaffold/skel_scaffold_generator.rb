...
class SkelScaffoldGenerator < Rails::Generator::NamedBase
  ...
  def manifest
    record do |m|
      ...
      m.template 'skel_scaffold:routing_spec.rb',
      ...
      for action in scaffold_views
        m.template(
          "skel_scaffold:view_#{action}.#{@default_file_extension}",
  ...
  protected
    ...
    def banner
      "Usage: #{$0} skel_scaffold ModelName [field:type field:type]"
    end
